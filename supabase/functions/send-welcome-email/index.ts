...
function createWelcomeEmail(userName: string, dashboardUrl: string) {
  const content = `
    <h1 style="margin: 0 0 24px 0; font-size: 28px; font-weight: 700; color: #1a1a1a;">
      Welcome to Content Charm 🎉
    </h1>
    ...
    <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #333333;">
      Welcome to Content Charm — we're glad you're here.
    </p>
    ...
    <div style="margin: 24px 0;">
      <div style="margin: 16px 0; padding: 16px; background-color: #f8f8f8; border-radius: 8px;">
        ...
        <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #555555;">
          Go to Clients → Add Client and enter their name and logo.
        </p>
      </div>
      ...
      <div style="margin: 16px 0; padding: 16px; background-color: #f8f8f8; border-radius: 8px;">
        ...
        <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #555555;">
          Click New Calendar, select your client, and add your first posts.
        </p>
      </div>
      ...
      <div style="margin: 16px 0; padding: 16px; background-color: #f8f8f8; border-radius: 8px;">
        ...
        <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #555555;">
          Hit Send to Client and they'll get a beautiful approval page instantly.
        </p>
      </div>
    </div>

    <p style="margin: 24px 0 16px 0; font-size: 16px; line-height: 1.6; color: #333333;">
      Your 14-day free trial is now active. No credit card needed until you're ready.
    </p>
    ...
    <p style="margin: 24px 0 0 0; font-size: 14px; line-height: 1.6; color: #666666;">
      If you have any questions just reply to this email — we're real people and we actually read these.
    </p>
  ...
  return {
    subject: 'Welcome to Content Charm 🎉',
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!userEmail || !userName || !dashboardUrl) {
      return new Response(
    ...
    if (!resendApiKey || resendApiKey === "re_123456789") {
      ...
      console.log("Subject: Welcome to Content Charm 🎉");
    ...
    const emailTemplate = createWelcomeEmail(userName, dashboardUrl);
